...
@rich_repr
class RISCVOpcode(Opcode, metaclass=FlyweightMeta):
    __slots__ = ("_args",)
    ...
    def __eq__(self, value: object) -> bool:
        if isinstance(value, RISCVOpcode):
...
def opcode[**P](func: Callable[P, None]) -> OpcodeFactory[P, RISCVOpcode]:
    new_opcode_cls = type(
    ...
    return cast(OpcodeFactory[P, RISCVOpcode], create)
