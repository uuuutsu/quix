...
@opcode
def call_z(left: Ref, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_eq(left: Ref, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_ge(left: Ref, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_gt(left: Ref, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_le(left: Ref, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_lt(left: Ref, if_: UnitProgram, else_: UnitProgram) -> None: ...
