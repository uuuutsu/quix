...
@opcode
def move(from_: Unit, to: dict[Unit, Value]) -> None: ...
@opcode
...
@opcode
def call_z(left: Wide, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_eq(left: Wide, right: Wide, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_ge(left: Wide, right: Wide, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_gt(left: Wide, right: Wide, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_le(left: Wide, right: Wide, if_: UnitProgram, else_: UnitProgram) -> None: ...
@opcode
def call_lt(left: Wide, right: Wide, if_: UnitProgram, else_: UnitProgram) -> None: ...
