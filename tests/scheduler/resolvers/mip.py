from quix.scheduler import Array, Blueprint, HardLink, Index, LifeCycle, MIPResolver, Owner, SoftLink
...
def test_hard_link() -> None:
    ...
    bp = Blueprint().add_constraint(o1, HardLink(o2, 10))
    ly = MIPResolver()(bp)
...
def test_soft_link() -> None:
    ...
    bp = Blueprint().add_constraint(o1, SoftLink({o2: 5, o3: 7}))
    ly = MIPResolver()(bp)
...
def test_soft_link_with_lifecycles() -> None:
    ...
    bp = (
        Blueprint()
        .add_constraint(o1, SoftLink({o2: 5, o3: 7}))
        .add_constraint(o1, SoftLink({o4: 5}))
        .add_constraint(o4, LifeCycle(1, 10))
        .add_constraint(o2, LifeCycle(7, 12))
    )
    ly = MIPResolver()(bp)
